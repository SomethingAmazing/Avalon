...
<p>
	...
	This will allow you to access the method via <a href="http://<?php echo $_SERVER['HTTP_HOST'].$this->uri->anchor('hello-world'); ?>">http://<?php echo $_SERVER['HTTP_HOST'].$this->uri->anchor('hello-world'); ?></a>
</p>